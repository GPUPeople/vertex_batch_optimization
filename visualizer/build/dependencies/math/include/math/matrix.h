...
namespace math
{
	...
	public:
		...
		MATH_FUNCTION friend matrix<T, 3U, 2U> transpose(const matrix& m)
		{
			return matrix<T, 3U, 2U>(m._11, m._21, m._12, m._22, m._13, m._23);
		}
	...
	public:
		...
		MATH_FUNCTION friend matrix<T, 3, 3> transpose(const affine_matrix& m)
		{
			return matrix<T, 3, 3>(m._11, m._21, constants<T>::zero(), m._12, m._22, constants<T>::zero(), m._13, m._23, constants<T>::one());
		}
	...
	public:
		...
		MATH_FUNCTION friend matrix<T, 4, 4> transpose(const affine_matrix& m)
		{
			return matrix<T, 4, 4>(m._11, m._21, m._31, constants<T>::zero(), m._12, m._22, m._32, constants<T>::zero(), m._13, m._23, m._33, constants<T>::zero(), m._14, m._24, m._34, constants<T>::one());
		}
